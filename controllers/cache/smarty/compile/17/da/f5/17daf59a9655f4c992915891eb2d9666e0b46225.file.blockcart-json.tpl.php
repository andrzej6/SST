<?php /* Smarty version Smarty-3.1.14, created on 2014-12-25 22:24:57
         compiled from "/home/gbs2/public_html/prestashop/themes/autumn/modules/blockcart/blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:403353392549c788c614812-06105529%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '17daf59a9655f4c992915891eb2d9666e0b46225' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/themes/autumn/modules/blockcart/blockcart-json.tpl',
      1 => 1419545054,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '403353392549c788c614812-06105529',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_549c788c84cdf7_54111007',
  'variables' => 
  array (
    'products' => 0,
    'product' => 0,
...
<?php if ($_valid && !is_callable('content_549c788c84cdf7_54111007')) {function content_549c788c84cdf7_54111007($_smarty_tpl) {?>
{
"products": [
...
,
		"image": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'atmn_normal'));?>
,
		"image_cart": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'atmn_xsmall'));?>
,
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode(ob_get_clean())?><?php }?>,
		"name": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(html_entity_decode(trim($_smarty_tpl->tpl_vars['product']->value['name']),2,'UTF-8'),30,'...',true));?>
,
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode(ob_get_clean())?><?php }else{ ?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPrice'][0][0]->displayWtPrice(array('p'=>$_smarty_tpl->tpl_vars['product']->value['total_wt']),$_smarty_tpl);?>
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode(ob_get_clean())?><?php }?>,
		"price_inc_vat": <?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPrice'][0][0]->displayWtPrice(array('p'=>$_smarty_tpl->tpl_vars['product']->value['total_wt']),$_smarty_tpl);?>
...
<?php if (isset($_smarty_tpl->tpl_vars['product']->value['attributes_small'])){?>
		"hasAttributes": true,
		"attributes": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['product']->value['attributes']);?>
,
<?php }else{ ?>
		"hasAttributes": false,
<?php }?>
...
,
"shippingCostinctax": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['shipping_costinctax']->value);?>
,
...
,
"totalinctax": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['totalinctax']->value);?>
,
...
,
"productTotalinctax": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['product_total_inctax']->value);?>
,
