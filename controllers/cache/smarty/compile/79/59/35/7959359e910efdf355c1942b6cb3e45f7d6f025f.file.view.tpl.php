<?php /* Smarty version Smarty-3.1.14, created on 2015-01-08 22:40:54
         compiled from "/home/gbs2/public_html/prestashop/adminGbs4221A/themes/default/template/controllers/customers/helpers/view/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7707627454af0776c1eac6-58755203%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7959359e910efdf355c1942b6cb3e45f7d6f025f' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/adminGbs4221A/themes/default/template/controllers/customers/helpers/view/view.tpl',
      1 => 1419426387,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '7707627454af0776c1eac6-58755203',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54af077724ad15_63794429',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54af077724ad15_63794429')) {function content_54af077724ad15_63794429($_smarty_tpl) {?>
...
?>
								<tr onclick="document.location = '?tab=AdminOrders&id_order=<?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
...
'">
									...
									<td>
										<a class="btn btn-default" href="?tab=AdminOrders&amp;id_order=<?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
&amp;vieworder&amp;token=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getAdminToken'][0][0]->getAdminTokenLiteSmarty(array('tab'=>'AdminOrders'),$_smarty_tpl);?>
">
...
?>
							<tr onclick="document.location = '?tab=AdminCarts&id_cart=<?php echo $_smarty_tpl->tpl_vars['cart']->value['id_cart'];?>
...
?>
						<tr onclick="document.location = '?tab=AdminOrders&id_order=<?php echo $_smarty_tpl->tpl_vars['product']->value['id_order'];?>
&vieworder&token=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getAdminToken'][0][0]->getAdminTokenLiteSmarty(array('tab'=>'AdminOrders'),$_smarty_tpl);?>
'">
							<td><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0][0]->dateFormat(array('date'=>$_smarty_tpl->tpl_vars['order']->value['date_add'],'full'=>0),$_smarty_tpl);?>
</td>
...
?>
						<tr onclick="document.location = '<?php echo $_smarty_tpl->tpl_vars['p']->value['url'];?>
'">
...
?>
						<tr onclick="document.location = '?tab=AdminGroups&amp;id_group=<?php echo $_smarty_tpl->tpl_vars['group']->value['id_group'];?>
...
?>
	...
	<div class="row">
		...
		<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayAdminCustomers",'id_customer'=>$_smarty_tpl->tpl_vars['customer']->value->id),$_smarty_tpl);?>
