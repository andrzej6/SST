<?php /* Smarty version Smarty-3.1.14, created on 2015-01-02 17:32:43
         compiled from "/home/gbs2/public_html/prestashop/themes/autumn/address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:92727696454a6d63b16f915-61573134%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5fc834afe1868a55f7f6e63483ae6638abc22b2c' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/themes/autumn/address.tpl',
      1 => 1419544522,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '92727696454a6d63b16f915-61573134',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54a6d63b613fc1_99765597',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54a6d63b613fc1_99765597')) {function content_54a6d63b613fc1_99765597($_smarty_tpl) {?>
...
<h1 class="page-header"><?php echo smartyTranslate(array('s'=>'Your addresses'),$_smarty_tpl);?>
</h1>
...
" method="post" class="box" id="add_address">
    ...
    <h3 class="section-header"><?php if (isset($_smarty_tpl->tpl_vars['id_address']->value)&&(isset($_POST['alias'])||isset($_smarty_tpl->tpl_vars['address']->value->alias))){?><?php echo smartyTranslate(array('s'=>'Your address'),$_smarty_tpl);?>
...
<sup>*</sup></label>
        ...
        <?php if ($_smarty_tpl->tpl_vars['field_name']->value=='State:name'){?>
            ...
            <div class="required id_state form-group clearfix">
                <div class="inline-element">
...
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value){?> <sup class="required">*</sup><?php }?></label>
...
<?php }?><?php }?>" />
    ...
    <?php if (!$_smarty_tpl->tpl_vars['stateExist']->value){?>
        <div class="required id_state form-group unvisible clearfix">
            <div class="inline-element">
                <label for="id_state"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <sup>*</sup></label>
                <select name="id_state" id="id_state" class="form-control">
...
" />
        <button type="submit" name="submitAddress" id="submitAddress" class="button-1 fill">
            <span>
                <?php echo smartyTranslate(array('s'=>'Save'),$_smarty_tpl);?>

            </span>
        </button>
        <p class="required required-legand"><sup>*</sup><?php echo smartyTranslate(array('s'=>'Required field'),$_smarty_tpl);?>
</p>
    </div>
</form>
...
<ul class="footer_links">
    <li class="back-to-myaccount">
        <a class="button-2 fill inline" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('addresses',true), ENT_QUOTES, 'UTF-8', true);?>
">
            <span class="wpicon wpicon-address-book"></span><?php echo smartyTranslate(array('s'=>'Back to your addresses'),$_smarty_tpl);?>
