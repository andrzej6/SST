<?php /* Smarty version Smarty-3.1.14, created on 2015-01-06 02:51:48
         compiled from "/home/gbs2/public_html/prestashop/themes/autumn/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:103711498554ab4dc4bfce09-99146797%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bb99976ce4d29a12e54896463f1eb74954572814' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/themes/autumn/history.tpl',
      1 => 1419544588,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '103711498554ab4dc4bfce09-99146797',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54ab4dc4d96553_13684359',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ab4dc4d96553_13684359')) {function content_54ab4dc4d96553_13684359($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/gbs2/public_html/prestashop/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<h1 class="page-header"><?php echo smartyTranslate(array('s'=>'Order history'),$_smarty_tpl);?>
</h1>
<h3 class="extra-info"><?php echo smartyTranslate(array('s'=>'Here are the orders you\'ve placed since your account was created.'),$_smarty_tpl);?>
</h3>
		...
		<table id="order-list" class="table table-bordered footab">
			<thead>
				<tr>
					...
					<th class="item" data-hide="phone,tablet"><?php echo smartyTranslate(array('s'=>'Date'),$_smarty_tpl);?>
</th>
					...
					<th data-hide="phone" class="item"><?php echo smartyTranslate(array('s'=>'Status'),$_smarty_tpl);?>
</th>
...
" target="_blank">
									<span class="wpicon wpicon-download"></span>&nbsp;<?php echo smartyTranslate(array('s'=>'PDF'),$_smarty_tpl);?>
						...
						<td class="history_detail">
							<a class="button-2 fill inline order-detail-button" href="javascript:showOrder(1, <?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
, '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-detail',true), ENT_QUOTES, 'UTF-8', true);?>
');">
								<span class="wpicon wpicon-search"></span><?php echo smartyTranslate(array('s'=>'Details'),$_smarty_tpl);?>

							</a>
							<?php if (isset($_smarty_tpl->tpl_vars['opc']->value)&&$_smarty_tpl->tpl_vars['opc']->value){?>
								<a class="button-1 fill inline order-reorder-button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".((string)$_smarty_tpl->tpl_vars['order']->value['id_order'])), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }else{ ?>
								<a class="button-1 fill inline order-reorder-button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".((string)$_smarty_tpl->tpl_vars['order']->value['id_order'])), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
		                        <span class="wpicon wpicon-undo"></span><?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
