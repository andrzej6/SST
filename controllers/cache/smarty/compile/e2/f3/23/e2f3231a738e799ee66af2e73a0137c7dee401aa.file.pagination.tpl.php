<?php /* Smarty version Smarty-3.1.14, created on 2014-12-26 00:14:12
         compiled from "/home/gbs2/public_html/prestashop/themes/autumn/pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1136656912549c7fe95f7ea2-46957828%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e2f3231a738e799ee66af2e73a0137c7dee401aa' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/themes/autumn/pagination.tpl',
      1 => 1419544667,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1136656912549c7fe95f7ea2-46957828',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_549c7fe9805c63_53377004',
  'variables' => 
  array (
    'no_follow' => 0,
    'p' => 0,
...
<?php if ($_valid && !is_callable('content_549c7fe9805c63_53377004')) {function content_549c7fe9805c63_53377004($_smarty_tpl) {?>
...
<?php }?>" class="pagination row parent">
...
<?php }?>" class="pagination_previous">
                            <a class="button-2 fill" <?php echo $_smarty_tpl->tpl_vars['no_follow_text']->value;?>
...
<?php }?>" class="disabled pagination_previous">
                            <span class="button-2 fill disabled"><?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</span>
                        </li>
                    <?php }?>
...
?>
                        <?php if ($_smarty_tpl->tpl_vars['p']->value==$_smarty_tpl->getVariable('smarty')->value['section']['pagination']['index']){?>
                            <li class="active current">
                                <span class="button-2 fill disabled"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['p']->value, ENT_QUOTES, 'UTF-8', true);?>
</span>
                            </li>
                        <?php }else{ ?>
                            <li>
...
">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['pages_nb']->value>$_smarty_tpl->tpl_vars['stop']->value+2){?>
                        ...
                        <li>
                            <a class="button-2 fill" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->goPage($_smarty_tpl->tpl_vars['requestPage']->value,$_smarty_tpl->tpl_vars['pages_nb']->value);?>
">
...
">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['pages_nb']->value==$_smarty_tpl->tpl_vars['stop']->value+2){?>
                        <li>
                            <a class="button-2 fill" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->goPage($_smarty_tpl->tpl_vars['requestPage']->value,$_smarty_tpl->tpl_vars['pages_nb']->value-1);?>
">
...
<?php }?>" class="disabled pagination_next">
                            <span class="button-2 fill disabled"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
</span>
                        </li>
                    <?php }?>
                </ul>
