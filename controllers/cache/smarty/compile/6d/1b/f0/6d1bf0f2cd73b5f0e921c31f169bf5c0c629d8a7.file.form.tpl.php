<?php /* Smarty version Smarty-3.1.14, created on 2015-01-04 16:34:42
         compiled from "/home/gbs2/public_html/prestashop/modules/wpautumn/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7211219254a96ba20a6e84-86108234%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d1bf0f2cd73b5f0e921c31f169bf5c0c629d8a7' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/modules/wpautumn/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1419548431,
      2 => 'file',
    ),
    '74ae791c04dbd56a7ec8df51c8acf0e0acdb48f2' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/adminGbs4221A/themes/default/template/helpers/form/form.tpl',
      1 => 1419425541,
      2 => 'file',
    ),
    'cd631d47f77117a1206d20aabafa60ba31a290ca' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/adminGbs4221A/themes/default/template/helpers/form/form_group.tpl',
      1 => 1419425541,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7211219254a96ba20a6e84-86108234',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54a96ba310c434_93858876',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54a96ba310c434_93858876')) {function content_54a96ba310c434_93858876($_smarty_tpl) {?>
...
" />
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['name']=="WPAC_bodyBackgroundColor"){?>
...
?>
    ...
    <?php }elseif($_smarty_tpl->tpl_vars['input']->value['name']=="merge_oldnewsletter"){?>

        <strong><?php echo smartyTranslate(array('s'=>'Please discard this area, if you did not use Autumn theme with Prestashop 1.5 before!'),$_smarty_tpl);?>
</strong>
...
<?php }else{ ?>9<?php }?> <?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])){?>col-lg-offset-3<?php }?>">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['name']=="WPAC_bodyBackgroundImage"||$_smarty_tpl->tpl_vars['input']->value['name']=="WPAC_backgroundImage"){?>
...
" style="width:100%;max-width:100px;"/><br />
...
" /> <?php echo smartyTranslate(array('s'=>'Delete'),$_smarty_tpl);?>
            ...
            <small><?php echo smartyTranslate(array('s'=>'Do not forget to save the options after deleted the image!'),$_smarty_tpl);?>
</small>
            <br /><br />
        <?php }?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '7211219254a96ba20a6e84-86108234');
content_54a96ba2b770c2_37547997($_smarty_tpl);
...
" />
    ...
    <?php }elseif($_smarty_tpl->tpl_vars['input']->value['name']=="merge_oldnewsletter"){?>
        ...
        <?php if (($_smarty_tpl->tpl_vars['oldNewsletterTableExists']->value&&$_smarty_tpl->tpl_vars['newsletterInstalled']->value)){?>

            <a class="important-button" href="<?php echo $_smarty_tpl->tpl_vars['current']->value;?>
&<?php echo $_smarty_tpl->tpl_vars['identifier']->value;?>
=<?php echo $_smarty_tpl->tpl_vars['form_id']->value;?>
&token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
&mergeOldNewsletter=1">
                <?php echo smartyTranslate(array('s'=>'Merge Subscriptions'),$_smarty_tpl);?>

            </a>
            <br />
            <br />
            <span class="warning-text">
                <?php echo smartyTranslate(array('s'=>'You are seeing this option because you have "Autumn Theme - Newsletter Block with Extended Features" module from previous version of the theme.
                      ...
                      After clicking the link, you may get further instructions, please check this area right after clicked the "Merge Subscriptions" button.'),$_smarty_tpl);?>

                <br />
                <br />
                <?php echo smartyTranslate(array('s'=>'Please make a database backup before clicking the "Merge Subscriptions" button.'),$_smarty_tpl);?>

            </span>

        <?php }elseif(($_smarty_tpl->tpl_vars['oldNewsletterTableExists']->value&&!$_smarty_tpl->tpl_vars['newsletterInstalled']->value)){?>

            <span class="warning-text">
                <?php echo smartyTranslate(array('s'=>'You have newsletter subscription data in your database from "Autumn Theme - Newsletter Block with Extended Features" module. Please make sure you have installed and enabled "Newsletter Block"
                      module. After that, you will be able to merge e-mail addresses from here.'),$_smarty_tpl);?>
        ...
        <?php }else{ ?>
            ...
            <span class="success-text">
                <?php echo smartyTranslate(array('s'=>'You have successfully merged e-mail addresses from "Autumn Theme - Newsletter Block with Extended Features" module. Please use the CSV export option from "Newsletter" module to make sure you have
                      ...
                      from Modules > Modules page.'),$_smarty_tpl);?>
...
<?php }?>
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2015-01-04 16:34:42
         compiled from "/home/gbs2/public_html/prestashop/adminGbs4221A/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_54a96ba2b770c2_37547997')) {function content_54a96ba2b770c2_37547997($_smarty_tpl) {?>
