<?php /* Smarty version Smarty-3.1.14, created on 2015-01-02 17:31:20
         compiled from "/home/gbs2/public_html/prestashop/themes/autumn/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:57690530054a6d5e88fc2f1-46102174%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a7f3c195bb6dc7940d7d7d6ee881aaffb91bb608' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/themes/autumn/authentication.tpl',
      1 => 1419544529,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '57690530054a6d5e88fc2f1-46102174',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54a6d5e91197f4_48757592',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54a6d5e91197f4_48757592')) {function content_54a6d5e91197f4_48757592($_smarty_tpl) {?>
...
<?php if (!isset($_smarty_tpl->tpl_vars['email_create']->value)){?>
	<div class="row authentication-page-wrapper">
...
" method="post" id="create-account_form" class="box inline">
				<h3 class="section-header"><?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
</h3>
...
" /><?php }?>
						<button class="button-1 fill" type="submit" id="SubmitCreate" name="SubmitCreate">
...
" method="post" id="new_account_form" class="box">
            <div id="opc_account_form" style="display: block; ">
                <h3 class="section-header"><?php echo smartyTranslate(array('s'=>'Instant checkout'),$_smarty_tpl);?>
</h3>
                <!-- Account -->
...
&nbsp;&nbsp;</option>
                ...
                <h3 class="section-header secondary"><?php echo smartyTranslate(array('s'=>'Delivery address'),$_smarty_tpl);?>
</h3>
...
" />
                ...
                <div class="form-group checkbox">
                    ...
                    <?php echo smartyTranslate(array('s'=>'Use another address for invoice'),$_smarty_tpl);?>
</label>
                </div>
                ...
                <div id="opc_invoice_address"  class="unvisible">
                    ...
                    <h3 class="section-header secondary"><?php echo smartyTranslate(array('s'=>'Invoice address'),$_smarty_tpl);?>
</h3>
                    <?php  $_smarty_tpl->tpl_vars['field_name'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['field_name']->_loop = false;
...
"<?php if ((isset($_smarty_tpl->tpl_vars['guestInformations']->value)&&$_smarty_tpl->tpl_vars['guestInformations']->value['id_country_invoice']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_smarty_tpl->tpl_vars['guestInformations']->value)&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])){?> selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
 ...
 <sup>*</sup></label>
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value){?>
                        <div class="form-group"><?php echo smartyTranslate(array('s'=>'You must register at least one phone number.'),$_smarty_tpl);?>
</div>
                    <?php }?>
...
" />
			...
			<div class="required submit form-group">
				<input type="hidden" name="display_guest_checkout" value="1" />
				<button type="submit" class="button-1 fill" name="submitGuestAccount" id="submitGuestAccount">
                    <?php echo smartyTranslate(array('s'=>'Proceed to checkout'),$_smarty_tpl);?>

				</button>
                <div class="required required-legand"><span><sup>*</sup><?php echo smartyTranslate(array('s'=>'Required field'),$_smarty_tpl);?>
</span></div>
			</div>
		</form>
	<?php }?>
...
<?php }else{ ?>
	...
	<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), ENT_QUOTES, 'UTF-8', true);?>
" method="post" id="account-creation_form" class="box">
		<?php echo $_smarty_tpl->tpl_vars['HOOK_CREATE_ACCOUNT_TOP']->value;?>

		<div class="account_creation">
			<h3 class="section-header"><?php echo smartyTranslate(array('s'=>'Your personal information'),$_smarty_tpl);?>
</h3>
			<div class="form-group clearfix">
				<label><?php echo smartyTranslate(array('s'=>'Title'),$_smarty_tpl);?>
</label>
...
&nbsp;&nbsp;</option>
		...
		<?php if ($_smarty_tpl->tpl_vars['b2b_enable']->value){?>
			<div class="account_creation">
				<h3 class="section-header secondary"><?php echo smartyTranslate(array('s'=>'Your company information'),$_smarty_tpl);?>
</h3>
				<div class="form-group">
...
<?php }?>" />
		...
		<?php if (isset($_smarty_tpl->tpl_vars['PS_REGISTRATION_PROCESS_TYPE']->value)&&$_smarty_tpl->tpl_vars['PS_REGISTRATION_PROCESS_TYPE']->value){?>
			<div class="account_creation">
				<h3 class="section-header secondary"><?php echo smartyTranslate(array('s'=>'Your address'),$_smarty_tpl);?>
</h3>
				<?php  $_smarty_tpl->tpl_vars['field_name'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['field_name']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['dlv_all_fields']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['field_name']->key => $_smarty_tpl->tpl_vars['field_name']->value){
...
<?php }?>" />
						...
						<!-- if customer hasn't update his layout address, country has to be verified but it's deprecated -->
					<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="Country:name"||$_smarty_tpl->tpl_vars['field_name']->value=="country"){?>
						<div class="required select form-group clearfix">
							<label for="id_country"><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
 <sup>*</sup></label>
                            <div class="inline-element">
                                <select name="id_country" id="id_country" class="form-control">
...
"<?php if ((isset($_POST['id_country'])&&$_POST['id_country']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])){?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
					...
					<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="State:name"||$_smarty_tpl->tpl_vars['field_name']->value=='state'){?>
						<?php $_smarty_tpl->tpl_vars['stateExist'] = new Smarty_variable(true, null, 0);?>
						<div class="required id_state select form-group clearfix">
							<label for="id_state"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <sup>*</sup></label>
                            <div class="inline-element">
                                <select name="id_state" id="id_state" class="form-control">
...
<?php }?>" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
				...
				<?php }?>		
				<?php if ($_smarty_tpl->tpl_vars['stateExist']->value==false){?>
					<div class="required id_state select unvisible form-group clearfix">
						<label for="id_state"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <sup>*</sup></label>
                        <div class="inline-element">
                            <select name="id_state" id="id_state" class="form-control">
...
<?php }?>" />
			...
			<div class="account_creation dni">
				<h3 class="section-header secondary"><?php echo smartyTranslate(array('s'=>'Tax identification'),$_smarty_tpl);?>
</h3>
				<div class="required form-group">
					<label for="dni"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
 <sup>*</sup></label>
...
<?php }?>" />
		...
		<div class="submit form-group">
			...
			<?php if (isset($_smarty_tpl->tpl_vars['back']->value)){?><input type="hidden" class="hidden" name="back" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
			<button type="submit" name="submitAccount" id="submitAccount" class="button-1 fill">
