<?php /* Smarty version Smarty-3.1.14, created on 2014-12-30 14:45:18
         compiled from "/home/gbs2/public_html/prestashop/themes/autumn/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:130014234354a2ba7ec623f9-43695271%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '01976bf2590dfba2e0b6f9b6f5a98fc8c32edb69' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/themes/autumn/contact-form.tpl',
      1 => 1419544558,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '130014234354a2ba7ec623f9-43695271',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54a2ba7eefe353_00591687',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54a2ba7eefe353_00591687')) {function content_54a2ba7eefe353_00591687($_smarty_tpl) {?>
...
" method="post" class="contact-form-box box" enctype="multipart/form-data">
        <h3 class="section-header"><?php echo smartyTranslate(array('s'=>'Send a message'),$_smarty_tpl);?>
</h3>

        <div class="form-group selector1 clearfix">
...
" <?php if (isset($_REQUEST['id_contact'])&&$_REQUEST['id_contact']==$_smarty_tpl->tpl_vars['contact']->value['id_contact']){?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['contact']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
                ...
                <div id="desc_contact0" class="desc_contact form-group">&nbsp;</div>
                <?php  $_smarty_tpl->tpl_vars['contact'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['contact']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['contacts']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['contact']->key => $_smarty_tpl->tpl_vars['contact']->value){
$_smarty_tpl->tpl_vars['contact']->_loop = true;
...
" class="desc_contact contact-title form-group" style="display:none;">
        ...
        <div class="form-group">
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['customerThread']->value['email'])){?>
                <input class="form-control" type="text" id="email" name="from" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customerThread']->value['email'], ENT_QUOTES, 'UTF-8', true);?>
" readonly="readonly" />
            <?php }else{ ?>
                <input class="form-control validate" type="text" id="email" name="from" data-validate="isEmail" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['email']->value, ENT_QUOTES, 'UTF-8', true);?>
" />
            <?php }?>
        </div>
...
<?php }?></textarea>
        ...
        <div class="submit form-group">
            <button type="submit" name="submitMessage" id="submitMessage" class="button-1 fill"><?php echo smartyTranslate(array('s'=>'Send'),$_smarty_tpl);?>
</button>
		</div>
</form>
<?php }?>
