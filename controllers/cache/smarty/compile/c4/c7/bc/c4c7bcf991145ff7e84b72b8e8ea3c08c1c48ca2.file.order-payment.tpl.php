<?php /* Smarty version Smarty-3.1.14, created on 2015-01-05 23:53:00
         compiled from "/home/gbs2/public_html/prestashop/themes/autumn/order-payment.tpl" */ ?>
<?php /*%%SmartyHeaderCode:46538845654ab23dc6d3ed4-29717694%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c4c7bcf991145ff7e84b72b8e8ea3c08c1c48ca2' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/themes/autumn/order-payment.tpl',
      1 => 1419544652,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '46538845654ab23dc6d3ed4-29717694',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54ab23dcb85785_51383491',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ab23dcb85785_51383491')) {function content_54ab23dcb85785_51383491($_smarty_tpl) {?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
	...
	<h1 class="page-header"><?php echo smartyTranslate(array('s'=>'Please choose your payment method'),$_smarty_tpl);?>
</h1>
<?php }else{ ?>
	<h1 class="order-opc-section-title">
        <span class="number">3</span>
        <span class="title"><?php echo smartyTranslate(array('s'=>'Please choose your payment method'),$_smarty_tpl);?>
</span>
    </h1>
<?php }?>
							...
							<table id="cart_summary" class="table table-bordered wpresponsive">
								<thead>
									<tr>
										...
										<th class="cart_total last_item"><?php echo smartyTranslate(array('s'=>'Total (ex VAT)'),$_smarty_tpl);?>
</th>
									</tr>
								</thead>
								<tfoot>
									<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
										...
										<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
											...
											<tr class="cart_total_price">
												<td colspan="4" class="text-right"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total products (ex VAT)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
<?php }?></td>
												<td colspan="2" class="special-alcels">
 ...
 (inc VAT)</div>
									...
									<tr class="cart_total_voucher" <?php if ($_smarty_tpl->tpl_vars['total_wrapping']->value==0){?>style="display:none"<?php }?>>
										<td colspan="4" class="text-right">
											<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
												<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
													<?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total gift wrapping (ex VAT):'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total gift wrapping cost:'),$_smarty_tpl);?>
<?php }?>
												<?php }else{ ?>
													<?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total gift wrapping (inc VAT)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total gift wrapping cost:'),$_smarty_tpl);?>
<?php }?>
												<?php }?>
											<?php }else{ ?>
										...
										<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value!=$_smarty_tpl->tpl_vars['total_shipping']->value){?>
											<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
												<tr class="cart_total_delivery" <?php if ($_smarty_tpl->tpl_vars['shippingCost']->value<=0){?> style="display:none"<?php }?>>
													<td colspan="4" class="text-right"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total shipping (ex VAT)'),$_smarty_tpl);?>
 ...
 (inc VAT)</div>
									...
									<tr class="cart_total_voucher" <?php if ($_smarty_tpl->tpl_vars['total_discounts']->value==0){?>style="display:none"<?php }?>>
										<td colspan="4" class="text-right">
											<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
												<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
													<?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total vouchers (ex VAT)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total vouchers'),$_smarty_tpl);?>
<?php }?>
												<?php }else{ ?>
													<?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total vouchers (inc VAT)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total vouchers'),$_smarty_tpl);?>
<?php }?>
												<?php }?>
											<?php }else{ ?>
									...
									<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
										...
										<?php }?>
										<tr class="cart_total_price">
											<td colspan="4" class="total_price_container text-right"><span><?php echo smartyTranslate(array('s'=>'Total (ex VAT)'),$_smarty_tpl);?>
</span></td>
											<td colspan="2" class="special-alcels" id="total_price_container">
...
');return false;" class="voucher_name"><?php echo $_smarty_tpl->tpl_vars['voucher']->value['name'];?>
 ...
 <br />
										...
										<?php }?>
										<td colspan="<?php if (!$_smarty_tpl->tpl_vars['voucherAllowed']->value){?>3<?php }else{ ?>2<?php }?>" class="total_price_container">
...
" class="button-2 fill inline">
                            <span class="wpicon wpicon-arrow-left3 small"></span><?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
