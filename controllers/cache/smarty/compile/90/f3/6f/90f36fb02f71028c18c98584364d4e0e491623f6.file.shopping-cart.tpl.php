<?php /* Smarty version Smarty-3.1.14, created on 2014-12-25 22:30:15
         compiled from "/home/gbs2/public_html/prestashop/themes/autumn/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1061757643549c78c390db83-48701800%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '90f36fb02f71028c18c98584364d4e0e491623f6' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/themes/autumn/shopping-cart.tpl',
      1 => 1419544495,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1061757643549c78c390db83-48701800',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_549c78c40d5735_95666354',
  'variables' => 
  array (
    'empty' => 0,
    'PS_CATALOG_MODE' => 0,
...
<?php if ($_valid && !is_callable('content_549c78c40d5735_95666354')) {function content_549c78c40d5735_95666354($_smarty_tpl) {?>
...
<h1 id="cart_title" class="page-header"><?php echo smartyTranslate(array('s'=>'Shopping-cart summary'),$_smarty_tpl);?>
</h1>

<?php if (!isset($_smarty_tpl->tpl_vars['empty']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
    <h3 class="shopping-cart-count"><?php echo smartyTranslate(array('s'=>'Your shopping cart contains'),$_smarty_tpl);?>
<span class="bold colored-text"> <?php echo $_smarty_tpl->tpl_vars['productNumber']->value;?>
		...
		<table id="cart_summary" class="table table-bordered wpresponsive">
			<thead>
				<tr>
					...
					<th class="cart_total item"><?php echo smartyTranslate(array('s'=>'Total (ex VAT)'),$_smarty_tpl);?>
</th>
				...
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
						<tr class="cart_total_price">
							<td colspan="<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value){?>4<?php }else{ ?>3<?php }?>" class="text-right"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total products (ex VAT)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
<?php }?></td>
							<td colspan="3" class="special-alcels">
							<div id="total_product" class="price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products']->value),$_smarty_tpl);?>
 </div>
							
							<div id="total_productincvat" class="tot-prod-incvat"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products_wt']->value),$_smarty_tpl);?>
 (inc VAT)</div>
...
<?php }?></td>
 ...
 (inc VAT)</div>
				...
				<?php }else{ ?>
					<tr class="cart_total_price">
						<td colspan="<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value){?>4<?php }else{ ?>3<?php }?>" class="text-right"><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
</td>
				...
				<tr<?php if ($_smarty_tpl->tpl_vars['total_wrapping']->value==0){?> style="display: none;"<?php }?>>
					<td colspan="<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value){?>4<?php }else{ ?>3<?php }?>" class="text-right">
						<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
...
<?php }?>
				...
				<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0&&!isset($_smarty_tpl->tpl_vars['virtualCart']->value)){?>
					<tr class="cart_total_delivery" style="<?php if (!isset($_smarty_tpl->tpl_vars['carrier']->value->id)||is_null($_smarty_tpl->tpl_vars['carrier']->value->id)){?>display:none;<?php }?>">
						<td colspan="<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value){?>4<?php }else{ ?>3<?php }?>" class="text-right"><?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>
</td>
					...
					<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value!=$_smarty_tpl->tpl_vars['total_shipping']->value){?>
						<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
							<tr class="cart_total_delivery" <?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0){?> style="display:none;"<?php }?>>
								<td colspan="<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value){?>4<?php }else{ ?>3<?php }?>" class="text-right"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total shipping (ex VAT)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
<?php }?></td>
								<td colspan="3" class="special-alcels">
								     <div id="total_shipping" class="price"> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value),$_smarty_tpl);?>
 </div>
								
								    <div id="tot-ship-incvat"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_shipping']->value),$_smarty_tpl);?>
 (inc VAT)</div>
...
<?php }?></td>
 ...
 (inc VAT)</div>
					...
					<?php }else{ ?>
						<tr class="cart_total_delivery"<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0){?> style="display:none;"<?php }?>>
							<td colspan="<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value){?>4<?php }else{ ?>3<?php }?>" class="text-right"><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
</td>
				...
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value){?>
					<tr class="cart_total_price">
						<td colspan="<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value){?>4<?php }else{ ?>3<?php }?>" class="text-right"><?php echo smartyTranslate(array('s'=>'Total (tax excl.)'),$_smarty_tpl);?>
</td>
					...
					<tr class="cart_total_tax">
						<td colspan="<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value){?>4<?php }else{ ?>3<?php }?>" class="text-right"><?php echo smartyTranslate(array('s'=>'Total tax'),$_smarty_tpl);?>
</td>
				...
				<tr class="cart_total_price">
                    <td colspan="<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value){?>4<?php }else{ ?>3<?php }?>" id="cart_voucher" class="cart_voucher">
...
<?php }?>" />
                                ...
                                <button type="submit" name="submitAddDiscount" class="button-1 fill"><span><?php echo smartyTranslate(array('s'=>'OK'),$_smarty_tpl);?>
</span></button>
                            </form>
                            <?php if ($_smarty_tpl->tpl_vars['displayVouchers']->value){?>
                                <div id="title" class="title-offers"><?php echo smartyTranslate(array('s'=>'Take advantage of our exclusive offers:'),$_smarty_tpl);?>
</div>
...
<br />
					...
					<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
						<td colspan="3" class="special-alcels" id="total_price_container">
						    <div id="total_price_label"><?php echo smartyTranslate(array('s'=>'Total'),$_smarty_tpl);?>
</div>
							
							
							<div id="total_price" class="price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_price_without_tax']->value),$_smarty_tpl);?>
 </div>
							
							<div id="total_priceincvat" class="tot-cost-incvat"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_price']->value),$_smarty_tpl);?>
 (inc VAT)</div>
...
<?php echo $_smarty_tpl->tpl_vars['textField']->index+1;?>
								...
								<td class="cart_quantity" colspan="<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value){?>4<?php }else{ ?>3<?php }?>">
...
"/>
										<div class="cart_quantity_button clearfix">
											<?php if ($_smarty_tpl->tpl_vars['product']->value['minimal_quantity']<($_smarty_tpl->tpl_vars['customization']->value['quantity']-$_smarty_tpl->tpl_vars['quantityDisplayed']->value)||$_smarty_tpl->tpl_vars['product']->value['minimal_quantity']<=1){?>
												<a id="cart_quantity_down_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
_<?php echo $_smarty_tpl->tpl_vars['id_customization']->value;?>
_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
" class="cart_quantity_down button-minus button-2 fill icon-only sharp-corners" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
...
" rel="nofollow" title="<?php echo smartyTranslate(array('s'=>'Subtract'),$_smarty_tpl);?>
">
...
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
_<?php echo $_smarty_tpl->tpl_vars['id_customization']->value;?>
" class="cart_quantity_down button-minus button-2 fill icon-only sharp-corners disabled" href="#" title="<?php echo smartyTranslate(array('s'=>'Subtract'),$_smarty_tpl);?>
">
                                                    <span class="wpicon wpicon-minus small"></span>
												</a>
											<?php }?>
											<a id="cart_quantity_up_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
_<?php echo $_smarty_tpl->tpl_vars['id_customization']->value;?>
_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
" class="cart_quantity_up button-plus button-2 fill icon-only sharp-corners" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
...
" rel="nofollow" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
">
...
_<?php echo $_smarty_tpl->tpl_vars['id_customization']->value;?>
_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
" class="cart_quantity_delete" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
...
" rel="nofollow" title="<?php echo smartyTranslate(array('s'=>'Delete'),$_smarty_tpl);?>
">
...
$_smarty_tpl->tpl_vars['addresses_style']->value['alias'] = 'address_title';?>
	...
	<?php if (((!empty($_smarty_tpl->tpl_vars['delivery_option']->value)&&!isset($_smarty_tpl->tpl_vars['virtualCart']->value))||$_smarty_tpl->tpl_vars['delivery']->value->id||$_smarty_tpl->tpl_vars['invoice']->value->id)&&!$_smarty_tpl->tpl_vars['opc']->value){?>
		<div class="order_delivery grid<?php if (!$_smarty_tpl->tpl_vars['have_non_virtual_products']->value){?> grid-1<?php }else{ ?> grid-2<?php }?>">
			<?php if (!isset($_smarty_tpl->tpl_vars['formattedAddresses']->value)||(count($_smarty_tpl->tpl_vars['formattedAddresses']->value['invoice'])==0&&count($_smarty_tpl->tpl_vars['formattedAddresses']->value['delivery'])==0)||(count($_smarty_tpl->tpl_vars['formattedAddresses']->value['invoice']['formated'])==0&&count($_smarty_tpl->tpl_vars['formattedAddresses']->value['delivery']['formated'])==0)){?>
				<?php if ($_smarty_tpl->tpl_vars['delivery']->value->id){?>
					<div class="item"<?php if (!$_smarty_tpl->tpl_vars['have_non_virtual_products']->value){?> style="display: none;"<?php }?>>
						<ul id="delivery_address" class="address box">
							<li><h3 class="section-header"><?php echo smartyTranslate(array('s'=>'Delivery address'),$_smarty_tpl);?>
 (<?php echo $_smarty_tpl->tpl_vars['delivery']->value->alias;?>
)</h3></li>
				...
				<?php if ($_smarty_tpl->tpl_vars['invoice']->value->id){?>
					<div class="item">
						<ul id="invoice_address" class="address box">
							<li><h3 class="section-header"><?php echo smartyTranslate(array('s'=>'Invoice address'),$_smarty_tpl);?>
 (<?php echo $_smarty_tpl->tpl_vars['invoice']->value->alias;?>
)</h3></li>
...
?>
					<div class="item"<?php if ($_smarty_tpl->tpl_vars['k']->value=='delivery'&&!$_smarty_tpl->tpl_vars['have_non_virtual_products']->value){?> style="display: none;"<?php }?>>
...
<?php }?>" class="button-2 fill inline" title="<?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
">
            <span class="wpicon wpicon-arrow-left3 small"></span><?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
...
<?php }?>" class="standard-checkout button-1 fill inline" title="<?php echo smartyTranslate(array('s'=>'Proceed to checkout'),$_smarty_tpl);?>
">
	...
	<?php if (!empty($_smarty_tpl->tpl_vars['HOOK_SHOPPING_CART_EXTRA']->value)){?>
		<div class="cart_navigation_extra">
			<div id="HOOK_SHOPPING_CART_EXTRA">
                <?php echo $_smarty_tpl->tpl_vars['HOOK_SHOPPING_CART_EXTRA']->value;?>
