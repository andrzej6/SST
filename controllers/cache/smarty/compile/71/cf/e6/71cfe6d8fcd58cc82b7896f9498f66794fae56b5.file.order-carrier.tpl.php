<?php /* Smarty version Smarty-3.1.14, created on 2015-01-05 23:52:48
         compiled from "/home/gbs2/public_html/prestashop/themes/autumn/order-carrier.tpl" */ ?>
<?php /*%%SmartyHeaderCode:114383833554ab23d09aabf1-98537420%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '71cfe6d8fcd58cc82b7896f9498f66794fae56b5' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/themes/autumn/order-carrier.tpl',
      1 => 1419544632,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '114383833554ab23d09aabf1-98537420',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54ab23d0d6b8a0_82172468',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ab23d0d6b8a0_82172468')) {function content_54ab23d0d6b8a0_82172468($_smarty_tpl) {?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
	...
	<div id="carrier_area">
		<h1 class="page-header"><?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>
</h1>
...
<?php }else{ ?>
	<div id="carrier_area" class="opc-main-block">
		<h1 class="order-opc-section-title">
            ...
            <span class="title"><?php echo smartyTranslate(array('s'=>'Delivery methods'),$_smarty_tpl);?>
</span>
        </h1>
...
?>
						<h3 class="section-header carrier_title">
...
"/>
													...
													<?php }?>
													<td <?php if ($_smarty_tpl->tpl_vars['option']->value['unique_carrier']){?>class="first_item spec-cell-align" <?php }?>>
														<input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['carrier']->value['instance']->id;?>
" name="id_carrier" />
														  <?php if (isset($_smarty_tpl->tpl_vars['carrier']->value['instance']->delay[$_smarty_tpl->tpl_vars['cookie']->value->id_lang])){?>
...
?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['giftAllowed']->value){?>
                    <div id="gift_option">
                        <div class="gift_title"><?php echo smartyTranslate(array('s'=>'Gift'),$_smarty_tpl);?>
</div>
                        ...
                        <div id="gift_div">
                            ...
                            <textarea id="gift_message" class="form-control message" name="gift_message"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value->gift_message, ENT_QUOTES, 'UTF-8', true);?>
</textarea>
                        </div>
                    </div>
                <?php }?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['recyclablePackAllowed']->value){?>
                    <div id="recyclable_option">
                        <div class="recyclable_title"><?php echo smartyTranslate(array('s'=>'Recyclable Package'),$_smarty_tpl);?>
</div>
    ...
    <?php if ($_smarty_tpl->tpl_vars['conditions']->value&&$_smarty_tpl->tpl_vars['cms_id']->value){?>
        <div id="tos_option">
            <div class="tos_title"><?php echo smartyTranslate(array('s'=>'Terms of service'),$_smarty_tpl);?>
</div>
            <div class="checkbox">
...
" class="iframe colored-text" rel="nofollow"><?php echo smartyTranslate(array('s'=>'(Read the Terms of Service)'),$_smarty_tpl);?>
</a>
            </div>
        </div>
    <?php }?>
...
" class="button-2 fill inline">
                ...
                <?php if (isset($_smarty_tpl->tpl_vars['virtual_cart']->value)&&$_smarty_tpl->tpl_vars['virtual_cart']->value||(isset($_smarty_tpl->tpl_vars['delivery_option_list']->value)&&!empty($_smarty_tpl->tpl_vars['delivery_option_list']->value))){?>
                    <button type="submit" name="processCarrier" class="standard-checkout button-1 fill">
