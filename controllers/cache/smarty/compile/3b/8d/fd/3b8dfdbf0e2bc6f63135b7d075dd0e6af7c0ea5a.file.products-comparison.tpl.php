<?php /* Smarty version Smarty-3.1.14, created on 2014-12-26 12:15:31
         compiled from "/home/gbs2/public_html/prestashop/themes/autumn/products-comparison.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1544362898549d5163b05c61-28277000%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3b8dfdbf0e2bc6f63135b7d075dd0e6af7c0ea5a' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/themes/autumn/products-comparison.tpl',
      1 => 1419544478,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1544362898549d5163b05c61-28277000',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_549d516415d865_20325759',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_549d516415d865_20325759')) {function content_549d516415d865_20325759($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/gbs2/public_html/prestashop/tools/smarty/plugins/function.math.php';
...
<h1 class="page-header"><?php echo smartyTranslate(array('s'=>'Product Comparison'),$_smarty_tpl);?>
</h1>
...
">
						...
						<div class="product-image-block">
							<a class="product_image img-wrapper" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->getLink(), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
">
								<img class="white-border-3px" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['product']->value->id_image,'atmn_normal'), ENT_QUOTES, 'UTF-8', true);?>
...
%
 ...
 <?php echo smartyTranslate(array('s'=>'per %s','sprintf'=>htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->unity, ENT_QUOTES, 'UTF-8', true)),$_smarty_tpl);?>
						...
						<div class="product_desc">
							<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['product']->value->description_short),70,'...');?>
                            ...
                            <div class="button-container">
                                <?php if ((!$_smarty_tpl->tpl_vars['product']->value->hasAttributes()||(isset($_smarty_tpl->tpl_vars['add_prod_display']->value)&&($_smarty_tpl->tpl_vars['add_prod_display']->value==1)))&&$_smarty_tpl->tpl_vars['product']->value->minimal_quantity==1&&$_smarty_tpl->tpl_vars['product']->value->customizable!=2&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
                                    <?php if (($_smarty_tpl->tpl_vars['product']->value->quantity>0||$_smarty_tpl->tpl_vars['product']->value->allow_oosp)){?>
                                        <a class="ajax_add_to_cart_button button-1 fill inline" data-id-product="<?php echo $_smarty_tpl->tpl_vars['product']->value->id;?>
...
">
                                    ...
                                    <?php }?>
                                <?php }?>
                                <a class="lnk_view button-2 fill inline" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->getLink(), ENT_QUOTES, 'UTF-8', true);?>
