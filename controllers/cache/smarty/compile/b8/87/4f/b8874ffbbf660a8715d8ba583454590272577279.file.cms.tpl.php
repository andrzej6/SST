<?php /* Smarty version Smarty-3.1.14, created on 2014-12-30 14:55:53
         compiled from "/home/gbs2/public_html/prestashop/themes/autumn/cms.tpl" */ ?>
<?php /*%%SmartyHeaderCode:69552961954a2bcf9dc10c4-35222548%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b8874ffbbf660a8715d8ba583454590272577279' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/themes/autumn/cms.tpl',
      1 => 1419544555,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '69552961954a2bcf9dc10c4-35222548',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54a2bcf9f1bac1_69217216',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54a2bcf9f1bac1_69217216')) {function content_54a2bcf9f1bac1_69217216($_smarty_tpl) {?>
...
" name="lnk_view" class="button btn btn-default"/>
	...
	<?php }?>
	<div class="rte<?php if ($_smarty_tpl->tpl_vars['content_only']->value){?> content_only<?php }?> normalized">
...
<?php }?>"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cms_category']->value->name, ENT_QUOTES, 'UTF-8', true);?>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['sub_category']->value)&&!empty($_smarty_tpl->tpl_vars['sub_category']->value)){?>	
			<h3 class="section-header t-align-left"><?php echo smartyTranslate(array('s'=>'List of sub categories in %s:','sprintf'=>$_smarty_tpl->tpl_vars['cms_category']->value->name),$_smarty_tpl);?>
</h3>
			<ul class="bullet">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['subcategory']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
		...
		<h3 class="section-header t-align-left"><?php echo smartyTranslate(array('s'=>'List of pages in %s:','sprintf'=>$_smarty_tpl->tpl_vars['cms_category']->value->name),$_smarty_tpl);?>
</h3>
			<ul class="bullet">
