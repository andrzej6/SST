<?php /* Smarty version Smarty-3.1.14, created on 2015-01-07 20:10:42
         compiled from "/home/gbs2/public_html/prestashop/modules/wpisotopetabs/views/templates/admin/wp_isotope_tabs/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:138551610354ad92c28be309-75336485%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ab9c1322deca1a5ca50f8145ee339e0cc140ae38' => 
    array (
      0 => '/home/gbs2/public_html/prestashop/modules/wpisotopetabs/views/templates/admin/wp_isotope_tabs/helpers/form/form.tpl',
      1 => 1419547932,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '138551610354ad92c28be309-75336485',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54ad92c38e37b0_21628216',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ad92c38e37b0_21628216')) {function content_54ad92c38e37b0_21628216($_smarty_tpl) {?>
...
" />
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['name']=='tab_content'){?>
...
<?php }else{ ?>9<?php }?> <?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])){?>col-lg-offset-3<?php }?>">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['name']=="product_autocomplete"){?>

        <div id="wpproductautocomplete">
            <div id="ajax_choose_product">
                <input type="text" value="" id="product_autocomplete_input" />
                <p class="preference_description"><?php echo smartyTranslate(array('s'=>'Begin typing the first letters of the product name, then select the product from the drop-down list. Do not forget to save the tab afterwards.'),$_smarty_tpl);?>
</p>
            </div>

            <div id="product_list" style="font-weight:bold;">
                <ul>
                    <?php if ((isset($_smarty_tpl->tpl_vars['tab_content_products']->value)&&$_smarty_tpl->tpl_vars['tab_content_products']->value)){?>
                        <?php  $_smarty_tpl->tpl_vars['tab_content_product'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tab_content_product']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['tab_content_products']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['tab_content_product']->key => $_smarty_tpl->tpl_vars['tab_content_product']->value){
$_smarty_tpl->tpl_vars['tab_content_product']->_loop = true;
?>
                            <li data-pid="<?php echo $_smarty_tpl->tpl_vars['tab_content_product']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['tab_content_product']->value['name'];?>
 (ref: <?php echo $_smarty_tpl->tpl_vars['tab_content_product']->value['ref'];?>
)<span class="delProduct" data-pid="<?php echo $_smarty_tpl->tpl_vars['tab_content_product']->value['id'];?>
" style="cursor: pointer;"><img src="../img/admin/delete.gif" /></span></li>
                        <?php } ?>
                    <?php }?>
                </ul>
            </div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '138551610354ad92c28be309-75336485');
content_54ad92c34cc7a7_16585149($_smarty_tpl);
...
<?php }?>
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2015-01-07 20:10:43
         compiled from "/home/gbs2/public_html/prestashop/adminGbs4221A/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_54ad92c34cc7a7_16585149')) {function content_54ad92c34cc7a7_16585149($_smarty_tpl) {?>
