...
function showOrder(mode, var_content, file)
{
    ...
    if (mode === 1) {
        ajaxData = 'id_order=' + var_content + '&ajax=true';
    } else {
        ajaxData = 'id_order_return=' + var_content + '&ajax=true';
    }
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            {
                var new_data = $(result).filter('#order-order-return-details').html();
                $(this).html(new_data);
                ...
                if ($('#order-detail-content .order_cb').length > 0)
                {
                    ...
                    $('#wrapper').on('click', '.return_quantity_down', function(e){
                        e.preventDefault();
                    ...
                    $('#wrapper').on('click', '.return_quantity_up', function(e){
                        e.preventDefault();
