...
<h1 class="page-header">{l s='Your addresses'}</h1>
...
<form action="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" method="post" class="box" id="add_address">
    ...
    <h3 class="section-header">{if isset($id_address) && (isset($smarty.post.alias) || isset($address->alias))}{l s='Your address'}{else}{l s='New address'}{/if}</h3>
    ...
    {foreach from=$ordered_adr_fields item=field_name}
        ...
        {if $field_name eq 'phone'}
            ...
            <div class="form-group phone-number">
                <label for="phone">{l s='Phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup class="required">*</sup>{/if}</label>
        ...
        {if $field_name eq 'phone_mobile'}
            ...
            <div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
                <label for="phone_mobile">{l s='Phone (other)'}</label>
    ...
    {if !$mobilePhoneExist}
        <div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
            <label for="phone_mobile">{l s='Phone (other)'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>**</sup>{/if}</label>
            <input class="validate form-control" data-validate="{$address_validation.phone_mobile.validate}" type="tel" id="phone_mobile" name="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{else}{if isset($address->phone_mobile)}{$address->phone_mobile|escape:'html':'UTF-8'}{/if}{/if}" />
        </div>
    {/if}
    ...
    <div class="form-group submit">
        ...
        <p class="required required-legand"><sup>*</sup>{l s='Required field'}</p>
    </div>
</form>

<ul class="footer_links">
    <li class="back-to-myaccount">
        <a class="button-2 fill inline" href="{$link->getPageLink('addresses', true)|escape:'html':'UTF-8'}">
            <span class="wpicon wpicon-address-book"></span>{l s='Back to your addresses'}
        </a>
    </li>
</ul>
