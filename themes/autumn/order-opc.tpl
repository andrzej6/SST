...
{if $PS_CATALOG_MODE}
	...
	<h1 class="page-header">{l s='Your shopping cart'}</h1>
...
{capture}<a class="button-2 fill inline" href="{$smarty.capture.addressUrlAdd}" title="{l s='Update' js=1}">{l s='Update' js=1}</a>{/capture}
