...
{if isset($cms) && !isset($cms_category)}
	...
	{/if}
	<div class="rte{if $content_only} content_only{/if} normalized">
		{$cms->content}
	</div>
{elseif isset($cms_category)}
	<div class="block-cms">
		...
		{if isset($sub_category) && !empty($sub_category)}	
			<h3 class="section-header t-align-left">{l s='List of sub categories in %s:' sprintf=$cms_category->name}</h3>
			<ul class="bullet">
		...
		<h3 class="section-header t-align-left">{l s='List of pages in %s:' sprintf=$cms_category->name}</h3>
			<ul class="bullet">
