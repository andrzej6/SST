...
var ajaxCart = {
	...
	overrideButtonsInThePage : function(){
		...
		$('#buy_block').on('click', '#add_to_cart button', function(e){
			e.preventDefault();
	...
	hideOldProductCustomizations : function (product, domIdProduct){
		...
		if (!product.hasCustomizedDatas && !removeLinks.length)
			$('div[data-id="' + domIdProduct + '"]' + ' span.remove_link').html('<a class="ajax_cart_block_remove_link" rel="nofollow" href="' + baseUri + '?controller=cart&amp;delete=1&amp;id_product=' + product['id'] + '&amp;ipa=' + product['idCombination'] + '&amp;token=' + static_token + '"><span class="wpicon wpicon-close small"></span></a>');
		if (product.is_gift)
	...
	updateProductQuantity : function (product, quantity){
		$('div[data-id=cart_block_product_' + product.id + '_' + (product.idCombination ? product.idCombination : '0')+ '_' + (product.idAddressDelivery ? product.idAddressDelivery : '0') + '] .quantity').fadeTo('fast', 0, function(){
			$(this).text(quantity);
				...
				if ($('div[data-id="cart_block_product_' + domIdProduct + '"]').length == 0)
				{
                    ...
                    var content =  '<div class="product row parent"><div class="unvisible row" data-id="cart_block_product_' + domIdProduct + '">';
                        ...
                        content +=  '<div class="row valign-middle">';
                            ...
                            content += '<div class="cart-info column col-2-16 fixed t-align-right"><span class="quantity-formated"><span class="quantity">' + this.quantity + '</span></span></div>';
                            ...
                            if (typeof(this.is_gift) == 'undefined' || this.is_gift == 0)
                                content += '<div class="column col-1-16 fixed t-align-right remove_link"><a rel="nofollow" class="ajax_cart_block_remove_link" href="' + baseUri + '?controller=cart&amp;delete=1&amp;id_product=' + productId + '&amp;token=' + static_token + (this.hasAttributes ? '&amp;ipa=' + parseInt(this.idCombination) : '') + '"><span class="wpicon wpicon-close small"></span></a></div>';
                            else
	...
	updateLayer : function(product){
		...
		$('#layer_cart_product_price').text(product.price + ' (ex VAT)');
		$('#layer_cart_product_price_inc_tax').text(product.price_inc_vat + ' (inc VAT)');
	...
	updateCartEverywhere : function(jsonData){
     ...
     // below need to be careful, not updating total in cart small icon in header 
		...
		if (parseFloat(jsonData.shippingCostFloat) > 0)
			{
			    ...
			    $('.ajax_cart_shipping_costinctax').text('[ ' + jsonData.shippingCostinctax + ' inc VAT ]');
			 }
		...
		$('.ajax_block_cart_total_inctax').text('[ ' + jsonData.totalinctax +' inc VAT ]');
		$('.ajax_block_products_total').text(jsonData.productTotal);
		$('.ajax_block_products_total_inctax').text('[ '+ jsonData.productTotalinctax + ' inc VAT ]');
