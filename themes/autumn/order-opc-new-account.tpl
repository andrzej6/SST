<div id="opc_new_account" class="opc-main-block">
	...
	<h1 class="order-opc-section-title">
        ...
        <span class="title">{l s='Account'}</span>
    </h1>
    ...
    <div class="row">
        <div class="column col-4-12">
            <form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
                <h3 class="section-header">{l s='Already registered?'}</h3>
                <div id="login_form_content">
                    ...
                    <div class=" form-group submit">
                        ...
                        <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button-1 fill">{l s='Sign in'}</button>
                    </div>
                </div>
            </form>
        </div>

        <div class="column col-8-12">
            <form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="new_account_form" class="box" autocomplete="on" autofill="on">
                <h3 id="new_account_title" class="section-header">{l s='New Customer'}</h3>
                <div id="opc_account_choice" class="t-align-center">
                    <div class="opc_account_choice_guest">
                        <button type="submit" class="button-1 fill" id="opc_guestCheckout">{l s='Guest checkout'}</button>
                    </div>

                    <div class="opc_account_choice_or">
                        {l s='or'}
                    </div>

                    <div class="opc_account_choice_create">
                        <button type="submit" class="button-1 fill" id="opc_createAccount">{l s='Create an account'}</button>
                    </div>
                </div>
                ...
                <div id="opc_account_form" class="unvisible">
                    ...
                    <div class="select form-group date-select clearfix">
                    ...
                    <h3 class="section-header secondary">{l s='Delivery address'}</h3>
                    {$stateExist = false}
                    {$postCodeExist = false}
                    {$dniExist = false}
                    ...
                    {if isset($one_phone_at_least) && $one_phone_at_least}
                        <div class="form-group">{l s='You must register at least one phone number.'}</div>
                    {/if}
                    ...
                    <div class="checkbox form-group">
                        ...
                        {l s='Use another address for invoice'}</label>
                    </div>
                    ...
                    <div id="opc_invoice_address" class="is_customer_param">
                        ...
                        <h3 class="section-header secondary">{l s='Invoice address'}</h3>
                    ...
                    <div class="submit opc-add-save form-group clearfix">
                        <button type="submit" name="submitAccount" id="submitAccount" class="button-1 fill">{l s='Save'}</button>
                        <div class="required opc-required required-legand">
