...
<div id="mywishlist">
	...
	<h1 class="page-header">{l s='My wishlists' mod='blockwishlist'}</h1>
	...
	{if $id_customer|intval neq 0}
		<form method="post" class="std box" id="form_wishlist">
			<fieldset>
				<h3 class="section-header">{l s='New wishlist' mod='blockwishlist'}</h3>
				...
				<div class="submit form-group">
                    <button id="submitWishlist" class="button-1 fill" type="submit" name="submitWishlist">
					...
					<tbody>
						{section name=i loop=$wishlists}
							<tr id="wishlist_{$wishlists[i].id_wishlist|intval}">
								<td>
									<a class="button-2 fill inline" href="javascript:;" onclick="javascript:WishlistManage('block-order-detail', '{$wishlists[i].id_wishlist|intval}');">
