...
{if $products}
    {if !$refresh}
        ...
        <ul class="display_list">
            <li>
                <a id="hideBoughtProducts" class="button_account button-2 fill inline" href="#" onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" title="{l s='Hide products' mod='blockwishlist'}">
                    <span class="wpicon wpicon-eye"></span>{l s='Hide products' mod='blockwishlist'}
                </a>
                <a id="showBoughtProducts" class="button_account button-2 fill inline" href="#" onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" title="{l s='Show products' mod='blockwishlist'}">
                    <span class="wpicon wpicon-eye2"></span>{l s='Show products' mod='blockwishlist'}
                </a>
            </li>
            {if count($productsBoughts)}
                <li>
                    <a id="hideBoughtProductsInfos" class="button_account button-2 fill inline" href="#" onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="{l s='Hide products' mod='blockwishlist'}">
                        <span class="wpicon wpicon-eye"></span>{l s="Hide bought product's info" mod='blockwishlist'}
                    </a>
                    <a id="showBoughtProductsInfos" class="button_account button-2 fill inline" href="#" onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="{l s='Show products' mod='blockwishlist'}">
                        <span class="wpicon wpicon-eye2"></span>{l s="Show bought product's info" mod='blockwishlist'}
                    </a>
                </li>
            {/if}
            <li class="close-wishlist-detail">
                <a id="hideSendWishlist" class="button_account button-2 fill icon-only inline"  href="#" onclick="WishlistVisibility('wishlistLinkTop', 'SendWishlist'); return false;" rel="nofollow" title="{l s='Close send this wishlist' mod='blockwishlist'}">
        ...
        <div class="box">
            ...
            <div class="submit form-group">
                <a id="showSendWishlist" class="button-1 fill" href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="{l s='Send this wishlist' mod='blockwishlist'}">
                    <span class="wpicon wpicon-envelop"></span>{l s='Send this wishlist' mod='blockwishlist'}
                </a>
            </div>
        </div>
    {/if}
    ...
    <div class="wlp_bought">
        <ul class="wlp_bought_list grid grid-4">
            {foreach from=$products item=product name=i}
                <li id="wlp_{$product.id_product}_{$product.id_product_attribute}" class="item box">
                    ...
                    <div class="product_infos">
                        ...
                        <div class="wishlist_product_detail">
                            ...
                            <div class="btn_action">
                                <a class="button-1 fill inline"  href="javascript:;" onclick="WishlistProductManage('wlp_bought_{$product.id_product_attribute}', 'update', '{$id_wishlist}', '{$product.id_product}', '{$product.id_product_attribute}', $('#quantity_{$product.id_product}_{$product.id_product_attribute}').val(), $('#priority_{$product.id_product}_{$product.id_product_attribute}').val());" title="{l s='Save' mod='blockwishlist'}">
