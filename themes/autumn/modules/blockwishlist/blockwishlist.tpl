...
<div id="wishlist_block" class="block account">
	...
	<div class="block_content">
		<div id="wishlist_block_list" class="expanded">
			...
			{else}
				<ul class="products no-products">
					<li>{l s='No products' mod='blockwishlist'}</li>
				</ul>
			{/if}
		</div>
		...
		<div class="lnk">
			...
			{/if}
			<a class="button-2 fill" href="{$link->getModuleLink('blockwishlist', 'mywishlist', array(), true)|addslashes}" title="{l s='My wishlists' mod='blockwishlist'}">
                <span class="wpicon wpicon-flag medium"></span>{l s='My wishlists' mod='blockwishlist'}
			</a>
		</div>
	</div>
</div>