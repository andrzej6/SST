...
<div id="myaccount-sidebar-block" class="block myaccount-column">
	<p class="title_block">
	...
	<div class="block_content list-block">
		...
		<div class="logout">
			<a class="button-2 fill" href="{$link->getPageLink('index', true, NULL, "mylogout")|escape:'html':'UTF-8'}" title="{l s='Sign out' mod='blockmyaccount'}">
