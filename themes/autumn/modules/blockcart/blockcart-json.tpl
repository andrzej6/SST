...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
		...
		"image": {$link->getImageLink($product.link_rewrite, $product.id_image, 'atmn_normal')|json_encode},
		"image_cart": {$link->getImageLink($product.link_rewrite, $product.id_image, 'atmn_xsmall')|json_encode},
		...
		"name": {$product.name|trim|html_entity_decode:2:'UTF-8'|truncate:30:'...':true|json_encode},
		...
		"price_inc_vat": {displayWtPrice|json_encode p=$product.total_wt},		
...
"shippingCostinctax": {$shipping_costinctax|json_encode},
...
"totalinctax": {$totalinctax|json_encode},
"productTotal": {$product_total|json_encode},
"productTotalinctax": {$product_total_inctax|json_encode},
