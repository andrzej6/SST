    ...
    {if $special}
		<ul>
        	<li class="t-align-center">
            	<a class="products-block-image img-wrapper" href="{$special.link|escape:'html':'UTF-8'}">
                    <img class="replace-2x white-border-3px" src="{$link->getImageLink($special.link_rewrite, $special.id_image, 'atmn_small')|escape:'html':'UTF-8'}" alt="{$special.legend|escape:'html':'UTF-8'}" title="{$special.name|escape:'html':'UTF-8'}" />
                </a>
		...
		<div>
			<a class="button-2 fill" href="{$link->getPageLink('prices-drop')|escape:'html':'UTF-8'}" title="{l s='All specials' mod='blockspecials'}">
