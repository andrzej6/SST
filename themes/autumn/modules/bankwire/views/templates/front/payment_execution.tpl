...
{else}
    <form action="{$link->getModuleLink('bankwire', 'validation', [], true)|escape:'html':'UTF-8'}" method="post">
        ...
        <div class="cart_navigation" id="cart_navigation">
        	<a class="button-2 fill inline" href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}">
                <span class="wpicon wpicon-arrow-left3 small"></span>{l s='Other payment methods' mod='bankwire'}
            </a>
