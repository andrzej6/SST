...
{else}
	...
	<h1 class="page-header">{l s='Order confirmation' mod='paypal'}</h1>
	...
	{else}
		<a href="{$link->getPageLink('history.php', true)}" title="{l s='Back to orders' mod='paypal'}" data-ajax="false" class="button-2 fill inline">
