...
{else}
	<div id="block_various_links_footer" class="footer-block item">
		<h4>{l s='Information' mod='blockcms'}<span class="wpicon wpicon-plus small"></span></h4>
        <div>
            <ul class="toggle-footer list-icon-arrow">
                ...
                <li>
                    <div>&copy; 2014 {l s='[1]Ecommerce software by %s[/1]' mod='blockcms' sprintf=['PrestaShop™'] tags=['<a class="_blank" href="http://www.prestashop.com">']}</div>
                </li>
                {/if}
            </ul>
            {$footer_text}
