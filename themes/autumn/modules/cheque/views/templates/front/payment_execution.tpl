...
<h1 class="page-header">{l s='Order summary' mod='cheque'}</h1>
...
{else}
	...
	<form action="{$link->getModuleLink('cheque', 'validation', [], true)|escape:'html':'UTF-8'}" method="post">
		<div class="box cheque-box">
			<h3 class="section-header">{l s='Check payment' mod='cheque'}</h3>
		...
		<div class="cart_navigation" id="cart_navigation">
			<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}" class="button-2 fill inline">
				<span class="wpicon wpicon-arrow-left3 small"></span>{l s='Other payment methods' mod='cheque'}
			</a>
