...
<form class="box" id="compare_shipping_form" method="post" action="#" >
	<div id="compare_shipping">
		<h3 class="section-header">{l s='Estimate the cost of shipping & taxes.' mod='carriercompare'}</h3>
        ...
        <div id="states" class="form-group clearfix" style="display: none;">
            <div class="inline-element">
        ...
        <div class="form-group last">
            ...
            <span class="form_info">{l s='Needed for certain carriers.' mod='carriercompare'}</span>
		</div>
        ...
        <div id="availableCarriers" style="display: none;">
			<table cellspacing="0" cellpadding="0" id="availableCarriers_table" class="table table-bordered wpresponsive">
				<thead>
					<tr>
		...
		<div class="SE_SubmitRefreshCard">
            <button class="button-2 fill" id="carriercompare_submit" type="button" name="carriercompare_submit">{l s='Update cart' mod='carriercompare'}</button>
            <button class="button-2 fill" id="update_carriers_list" type="button">{l s='Update carrier list' mod='carriercompare'}</button>
		</div>
	</div>
</form>
