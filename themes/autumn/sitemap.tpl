...
<div class="box">
    <div id="sitemap_content" class="grid grid-2">
        <div class="item">
            <h3 class="section-header t-align-left">{l s='Our offers'}</h3>
            <ul class="list-icon-arrow">
                ...
                {if $display_manufacturer_link OR $PS_DISPLAY_SUPPLIERS}
                    <li>
                        <a href="{$link->getPageLink('manufacturer')|escape:'html':'UTF-8'}" title="{l s='View a list of manufacturers'}">{l s='Manufacturers'}</a>
                    </li>
                {/if}
...
<div class="box">
    <div id="listpage_content" class="grid grid-1">
        <div class="categTree item">
            <h3 class="section-header t-align-left">{l s='Categories'}</h3>
        ...
        <div class="item">
            <h3 class="section-header secondary t-align-left">{l s='Pages'}</h3>
            <ul class="list-icon-arrow">
                <li>
