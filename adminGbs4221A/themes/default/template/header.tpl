						...
						<div class="dropdown-menu notifs_dropdown">
							<section id="customer_messages_notif_wrapper" class="notifs_panel">
								...
								<div class="notifs_panel_footer">
								     ...
								     <a href="index.php?controller=AdminCustomerThreads&amp;customer_threadOrderby=date_upd&amp;customer_threadOrderway=desc&amp;token={getAdminToken tab='AdminCustomerThreads'}">{l s='Show all messages'}</a> 
