...
<p class="payment_module">
	<a href="javascript:void(0);" onclick="$('#worldpay_payment_form').submit();" title="{$request_title|escape:'html'}">
		<img src="{$this_path}/views/img/worldpay260.jpg" alt="{$request_title|escape:'html'}" width="86" height="49" />
