 ...
 *         	 		 	 	 	   
 */
class AdminBarclaycardCwRefundController extends AdminController
{
	public function __construct() {
		$this->className = 'AdminBarclaycardCwRefundController';
		parent::__construct();
		$this->context->smarty->addTemplateDir($this->getTemplatePath());
		$this->tpl_folder = 'barclaycardcw_refund/';
		$this->bootstrap = true;
	}
	...
	public function initContent()
	{
		...
		$data = $_GET;
		$transaction = current(BarclaycardCw_Entity_Transaction::getTransactionsByOrderId((int)$data['id_order']));
		...
		$vars['refundAmount'] = BarclaycardCw::getRefundAmount($data);
