...
class BarclaycardCwIframeModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
		...
		if (!($wrapper instanceof BarclaycardCw_Adapter_IframeAdapter)) {
			throw new Exception("Expect 'BarclaycardCw_Adapter_IframeAdapter'.");
		}
