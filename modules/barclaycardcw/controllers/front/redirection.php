...
class BarclaycardCwRedirectionModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
		...
		$dbTransaction = BarclaycardCw_Entity_Transaction::loadById(intval($_GET['cw_transaction_id']));
		...
		$authorizationAdapter = BarclaycardCw_Util::getAuthorizationAdapter($dbTransaction->getTransactionObject()->getAuthorizationMethod());
