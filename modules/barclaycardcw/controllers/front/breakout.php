...
class BarclaycardCwBreakOutModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
		...
		$dbTransaction = BarclaycardCw_Entity_Transaction::loadById($id_transaction);
		...
		$this->context->smarty->assign(array('url' => $redirectionUrl));
		$this->setTemplate('breakout.tpl');
