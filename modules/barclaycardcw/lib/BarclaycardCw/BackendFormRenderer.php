...
require_once 'BarclaycardCw/ConfigurationAdapter.php';
...
class BarclaycardCw_BackendFormRenderer extends Customweb_Form_Renderer
{
	...
	public function __construct() {
		$this->configurationAdapter = new BarclaycardCw_ConfigurationAdapter();
		$this->setCssClassPrefix('barclaycardcw-');
	}
