	...
	protected function preparePaymentFormPane() {
		...
		if ($this->getTransaction() !== null) {
			if ($this->visibleFormFields !== null && count($this->visibleFormFields) > 0) {
				$link = new Link();
				$this->formActionUrl = $link->getModuleLink('barclaycardcw', 'widget', array('cw_transaction_id' => $this->getTransaction()->getTransactionId(), 'id_module' => Tools::getValue('id_module', null)) , true);
			}
			else {
