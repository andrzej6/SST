 ...
 */
class Customweb_Barclaycard_Method_LineItemBuilder_AmazonCheckout extends Customweb_Barclaycard_AbstractLineItemBuilder {
	 ...
	 * (non-PHPdoc)
	 * 
	 * @see Customweb_Barclaycard_AbstractLineItemBuilder::getLineItemFields()
	 */
