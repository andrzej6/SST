...
require_once 'Customweb/Barclaycard/Method/Invoice/Open/Abstract.php';
require_once 'Customweb/Barclaycard/Util.php';
require_once 'Customweb/Barclaycard/Method/Invoice/Open/PostFinanceFis/LineItemBuilder.php';
 ...
 */
class Customweb_Barclaycard_Method_Invoice_Open_PostFinanceFis extends Customweb_Barclaycard_Method_Invoice_Open_Abstract {
	...
	public function getAuthorizationParameters(Customweb_Barclaycard_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		$builder = new Customweb_Barclaycard_Method_Invoice_Open_PostFinanceFis_LineItemBuilder($transaction->getTransactionContext()->getOrderContext());
