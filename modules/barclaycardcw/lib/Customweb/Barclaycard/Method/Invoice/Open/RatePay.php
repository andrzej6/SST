...
require_once 'Customweb/Barclaycard/Method/Invoice/LineItemBuilder/RatePay.php';
 ...
 */
class Customweb_Barclaycard_Method_Invoice_Open_RatePay extends Customweb_Barclaycard_Method_Invoice_Open_Abstract {
	...
	public function getAuthorizationParameters(Customweb_Barclaycard_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		$builder = new Customweb_Barclaycard_Method_Invoice_LineItemBuilder_RatePay($transaction->getTransactionContext()->getOrderContext());
