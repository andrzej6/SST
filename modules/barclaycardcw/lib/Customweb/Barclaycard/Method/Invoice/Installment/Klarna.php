...
require_once 'Customweb/Barclaycard/Method/Invoice/LineItemBuilder/Klarna.php';
require_once 'Customweb/Util/String.php';
require_once 'Customweb/Barclaycard/Util.php';
require_once 'Customweb/Payment/Authorization/IInvoiceItem.php';
require_once 'Customweb/Barclaycard/Method/Invoice/Installment/Abstract.php';
 ...
 */
class Customweb_Barclaycard_Method_Invoice_Installment_Klarna extends Customweb_Barclaycard_Method_Invoice_Installment_Abstract {
...
public function getSupportedCountries() {
	...
	public function getAuthorizationParameters(Customweb_Barclaycard_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		$builder = new Customweb_Barclaycard_Method_Invoice_LineItemBuilder_Klarna($transaction->getTransactionContext()->getOrderContext());
