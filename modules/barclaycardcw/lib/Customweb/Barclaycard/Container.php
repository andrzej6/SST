 ...
 *
 */
class Customweb_Barclaycard_Container extends Customweb_Payment_AbstractContainer {
	...
	public function getConfiguration(){
		return $this->getBean('Customweb_Barclaycard_Configuration');
	}
	...
	public function getMethodFactory(){
		return $this->getBean('Customweb_Barclaycard_Method_Factory');
	}
	 ...
	 * @return Customweb_Barclaycard_Method_IMethod
	 */
