 ...
 * @BackendForm
 */
final class Customweb_Barclaycard_BackendOperation_Form_StaticTemplate extends Customweb_Payment_BackendOperation_Form_Abstract {
	const STORAGE_SPACE_KEY = 'Barclaycard_StaticTemplate';

	public static function getTemplateFields(){
		return array(
			'TITLE' => array(
				'label' => Customweb_I18n_Translation::__('Title'),
				'desc' => Customweb_I18n_Translation::__('Title and Header of the payment page'),
				'default' => '' 
			),
			'BGCOLOR' => array(
...
have a secure environment to store your image, contact your Barclaycard to store your logo on their server.'),
				'default' => '' 
			) 
		);
	}
