...
require_once 'Customweb/Barclaycard/MasterPass/Checkout.php';
 ...
 *
 */
class Customweb_Barclaycard_CheckoutService implements Customweb_Payment_ExternalCheckout_IProviderService {
	...
	public function __construct(Customweb_DependencyInjection_IContainer $container) {
		$this->masterPassCheckout = new Customweb_Barclaycard_MasterPass_Checkout();
