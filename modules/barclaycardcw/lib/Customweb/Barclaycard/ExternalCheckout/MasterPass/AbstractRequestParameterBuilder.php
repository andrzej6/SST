...
abstract class Customweb_Barclaycard_ExternalCheckout_MasterPass_AbstractRequestParameterBuilder {
	...
	public function __construct(Customweb_Payment_ExternalCheckout_IContext $context, Customweb_Barclaycard_Container $container) {
	...
	/**
	 * @return Customweb_Barclaycard_Container
	 */
