...
class Customweb_Barclaycard_ExternalCheckout_MasterPass_RedirectionRequestParameterBuilder extends Customweb_Barclaycard_ExternalCheckout_MasterPass_AbstractRequestParameterBuilder{
	
	private $token;
	
	public function __construct(Customweb_Payment_ExternalCheckout_IContext $context, Customweb_Barclaycard_Container $container, $token) {
