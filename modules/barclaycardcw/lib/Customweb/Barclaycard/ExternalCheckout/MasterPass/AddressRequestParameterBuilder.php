...
class Customweb_Barclaycard_ExternalCheckout_MasterPass_AddressRequestParameterBuilder extends Customweb_Barclaycard_ExternalCheckout_MasterPass_AbstractRequestParameterBuilder{
	
	private $data;
	
	public function __construct(Customweb_Payment_ExternalCheckout_IContext $context, Customweb_Barclaycard_Container $container, $data) {
