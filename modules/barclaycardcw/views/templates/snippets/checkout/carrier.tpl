<div class="order_carrier_content barclaycardcw-external-checkout-carrier-box box">
	...
	{if isset($virtual_cart) && $virtual_cart}
		<p>{lcw s='No shipping method needed.' mod='barclaycardcw'}</p>
...
<p class="cart_navigation clearfix">
	{if isset($virtual_cart) && $virtual_cart || (isset($delivery_option_list) && !empty($delivery_option_list))}
		<button type="submit" name="processCarrier" id="shipping-method-submit-button" class="button btn btn-default standard-checkout button-medium">
			<span>
				{lcw s='Save Shipping Method' mod='barclaycardcw'}
...
<!-- 
	jQuery('.barclaycardcw-external-checkout-carrier-box').each(function() {
		var box = $(this);
		box.find("input[type='radio']").change(function() {
			$('#shipping-method-submit-button').click();
		});
	});
//-->
</script>
