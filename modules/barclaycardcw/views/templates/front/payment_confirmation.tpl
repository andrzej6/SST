...
<h1 class="page-heading">{lcw s='Order Confirmation' mod='barclaycardcw'}</h1>
...
{else}
	...
	<p>{lcw s='CONFIRM_ORDER_TEXT' mod='barclaycardcw' }</p>
	...
	<p class="cart_navigation clearfix">
		<a href="{$link->getPageLink('order', true, NULL, "step=3")}" class="button-exclusive btn btn-default">
			...
			{lcw s='Other payment methods' mod='barclaycardcw'}
		</a>
	</p>
{/if}
