...
class BlockCart extends Module
{
	...
	public function assignContentVars($params)
	{
		...
		$base_shippinginctax = $params['cart']->getOrderTotal(true, Cart::ONLY_SHIPPING);
		$shipping_cost = Tools::displayPrice($base_shipping, $currency);
		$shipping_costinctax = Tools::displayPrice($base_shippinginctax, $currency);
		...
		$totalToPayinctax = $params['cart']->getOrderTotal(true);
		...
		foreach ($cart_rules as &$cart_rule)
		{
			if ($cart_rule['free_shipping'])
			{
				...
				$shipping_costinctax = Tools::displayPrice(0, $currency);
		...
		$this->smarty->assign(array(
			...
			'shipping_costinctax' => $shipping_costinctax,
			...
			'product_total_inctax' => Tools::displayPrice($params['cart']->getOrderTotal(true, Cart::BOTH_WITHOUT_SHIPPING), $currency),
			'total' => Tools::displayPrice($totalToPay, $currency),
			'totalinctax' => Tools::displayPrice($totalToPayinctax, $currency),
