{capture name=path}<a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='All Blog Posts' mod='smartblog'}</a><span class="navigation-pipe">{$navigationPipe}</span>{$meta_title}{/capture}
   ...
   <div itemtype="#" itemscope="" id="sdsblogArticle" class="blog-post">
      ...
      <div class="post-info">
         ...
         {assign var="catOptions" value=null}
                   ...
                   {if $smartshowauthor ==1}&nbsp;<i class="icon icon-user"></i><span itemprop="author">
                   ...
                   <span itemprop="dateCreated">{$created|date_format}
                   </span>
                  ...
                  <span itemprop="articleSection">
                     <a href="{smartblog::GetSmartBlogLink('smartblog_category',$catOptions)}" class="blog-catlinks">{$title_category}</a>
                  </span>
                   &nbsp;<i class="icon icon-comments"></i>&nbsp; 
                     {if $countcomment != ''}{$countcomment}
                     {else}{l s='0' mod='smartblog'}
                     {/if}
                     {l s=' Comments' mod='smartblog'}
                      </span>
                       <a title="" style="display:none" itemprop="url" href="#" class="blog-catlinks"></a>
      </div>
...
<div class="smartblogcomments" id="respond">
	...
	<table>
		...
		<tbody><tr>
	<td class="blog-leftcol"><span class="required">*</span> <b>{l s="Name:"  mod="smartblog"} </b></td>
		<td class="blog-reply">
	<input type="text" tabindex="1" class="inputName form-control grey" value="" name="name">																	
		</td>
	</tr>
        <tr>
		<td class="blog-leftcol"><span class="required">*</span> <b>{l s="E-mail:"  mod="smartblog"} </b><span class="note">{l s="(Not Published)"  mod="smartblog"}</span></td>
			<td class="blog-reply">
		<input type="text" tabindex="2" class="inputMail form-control grey" value="" name="mail">
			</td>
		</tr>
		<tr>
			<td class="blog-leftcol">&nbsp;&nbsp;&nbsp;<b>{l s="Website:"  mod="smartblog"} </b></td>
		<td class="blog-reply"><input type="text" tabindex="3" value="" name="website" class="form-control grey"></td>
		</tr>
			<tr style="height:100px">
			<td class="blog-leftcol"><span class="required">*</span> <b> {l s="Comment:"  mod="smartblog"}</b></td>
		<td class="blog-reply">
		<textarea tabindex="4" class="inputContent form-control grey" rows="30" cols="80" name="comment" style="height:100px;"></textarea>
	</td>
	</tr>
	{if Configuration::get('smartcaptchaoption') == '1'}
		<tr>
			<td class="blog-leftcol"></td><td class="blog-reply"><img src="{$modules_dir}smartblog/classes/CaptchaSecurityImages.php?width=100&height=40&characters=5"></td>
		</tr><tr>
		<td class="blog-leftcol"><b>{l s="Type Code" mod="smartblog"}</b></td><td class="blog-reply"><input type="text" tabindex="" value="" name="smartblogcaptcha" class="smartblogcaptcha form-control grey"></td>
		</tr>
	{/if}
	</tbody></table>
