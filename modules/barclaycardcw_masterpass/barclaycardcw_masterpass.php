...
/**
 * BarclaycardCw_MasterPass 
 * 
 * This class defines is the module class for the 
 * payment method "MasterPass".
 * 
 * @author customweb GmbH
 */
class BarclaycardCw_MasterPass extends BarclaycardCw_PaymentMethod
{
	public $name = 'barclaycardcw_masterpass';
	public $paymentMethodName = 'masterpass';
	public $paymentMethodDisplayName = 'MasterPass';
